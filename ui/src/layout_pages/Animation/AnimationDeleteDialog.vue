        ...
        >
            <div style="width: 100%" class="q-pl-md bl">
                <div class="row q-pb-md">
                    <p class="q-my-none text-red text-h4 ">DELETE ANIMATION</p>
                </div>
                <div class="row q-pb-md">
                    <p class="q-my-none text-body1 text-white ">
                        Please input
                        <span class="text-red text-weight-bold">{{ animation.reservedNames[$i18n.locale] || animation.name }}</span>
            ...
            <div style="width: 100%" class="q-pl-md">
                <div class="row justify-end">
                    ...
                    <q-btn
                        ...
                        :disable="!isValid"
                        @click="commitAnimationDelete(animation.id)"
                    >
                        commit
                    </q-btn>
                </div>
...
export default {
    ...
    methods: {
        commitAnimationDelete(id) {
            let data = {id: id}
            this.$axios.post('api/animation/delete', data).then((response) => {
    ...
    computed: {
        isValid(){
            return this.confirmation ===(this.animation.reservedNames[this.$i18n.locale] || this.animation.name)
        },
        initialized() {
