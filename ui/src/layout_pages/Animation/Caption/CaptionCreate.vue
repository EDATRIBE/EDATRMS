        ...
        commitCreate() {
            ...
            this.$axios.post('api/caption/create', this.captionCreateBuffer.data).then((response) => {
                ...
                if (rd.code === 'success') {
                    ...
                    if (this.selectedUserModelsBuffer.data.length === 0){
                        ...
                        for (const selectedUserMode of this.selectedUserModelsBuffer.data) {
                            temp.userIds.push(selectedUserMode.value)
                        }
