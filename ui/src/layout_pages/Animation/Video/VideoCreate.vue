                ...
                <div style="width: 100%" class="q-pl-md bl">
                    ...
                    <div class="row items-center q-py-sm">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <q-input
                                ...
                                v-model="videoCreateBuffer.data.fileMeta.name"
                            >
                            </q-input>
                        </div>
                    </div>
                    ...
                    <div class="row items-center q-py-sm">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <q-select
                                ...
                                standout=""
                                v-model="videoCreateBuffer.data.fileMeta.type"
                                hide-bottom-space
                                :options="typeModels"
                                emit-value
                                map-options
                    ...
                    <div class="row items-center q-py-sm">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <q-input
                                dense dark class="bg-dark-light" standout=""
                                v-model="videoCreateBuffer.data.fileMeta.size"
                            >
                            </q-input>
                        </div>
                    </div>
                    ...
                    <div class="row items-center q-py-sm">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <q-select
                                ...
                                options-selected-class="text-primary"
                                standout=""
                                v-model="videoCreateBuffer.data.fileMeta.quality"
                                hide-bottom-space
                    ...
                    <div class="row items-center q-py-sm">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <q-input
                                dense dark class=" bg-dark-light" standout=""
                                v-model="videoCreateBuffer.data.comment"
                            >
                            </q-input>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        commitCreate() {
            this.videoCreateBuffer.data.animationId = this.animation.id
            this.$axios.post('api/video/create', this.videoCreateBuffer.data).then((response) => {
