        ...
        >
            <div style="width: 100%" class="q-pl-md bl">
                <div class="row q-pb-md">
                    <p class="q-my-none text-red text-h4 ">DELETE NOVEL</p>
                </div>
                <div class="row q-pb-md">
                    <p class="q-my-none text-body1 text-white ">
                        Please input
                        <span class="text-red text-weight-bold">{{ novel.reservedNames[$i18n.locale] || novel.name }}</span>
            ...
            <div style="width: 100%" class="q-pl-md">
                <div class="row justify-end">
                    ...
                    <q-btn
                        ...
                        :disable="!isValid"
                        @click="commitNovelDelete(novel.id)"
                    >
                        commit
                    </q-btn>
                </div>
...
export default {
    ...
    methods: {
        commitNovelDelete(id) {
            let data = {id: id}
            this.$axios.post('api/novel/delete', data).then((response) => {
    ...
    computed: {
        isValid(){
            return this.confirmation ===(this.novel.reservedNames[this.$i18n.locale] || this.novel.name)
        },
        initialized() {
