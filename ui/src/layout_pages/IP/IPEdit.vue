        ...
        <div class="q-mx-auto" style="width: 95%">
            <div class="column full-width">
                ...
                <div style="width: 100%" class="q-pl-md bl">
                    ...
                    <div class="row items-center q-py-sm">
                        <div class="col-md-2 col-xs-12">
                            <p class="q-my-none text-grey text-body1 text-weight-medium">WRITTEN BY</p>
                        </div>
                        <div class="col-md-10 col-xs-12">
                            <q-input
                                dense dark class=" bg-dark-light" standout=""
                                v-model="IPEditBuffer.data.writtenBy"
                            >
                            </q-input>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        initIPEditBuffer(ip) {
            ...
            this.IPEditBuffer.data.writtenBy = ip.writtenBy
