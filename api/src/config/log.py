    ...
    return {
        ...
        "loggers": {
            ...
            "sanic.access": {
                ...
                "handlers": [
                    config.get("LOGGER_SANIC_ACCESS_HANDLER", "access_console")
                ],
                "propagate": True,
        ...
        "handlers": {
            ...
            "access_file": {
                ...
                "formatter": "access",
                "filename": "{}".format(
                    os.path.join(config["DATA_PATH"], config["LOGS_DIR"], "access.log")
                ),
            ...
            "app_file": {
                ...
                "formatter": "generic",
                "filename": "{}".format(
                    os.path.join(config["DATA_PATH"], config["LOGS_DIR"], "app.log")
                ),
                "maxBytes": 10 * 1024 * 1024,
            },
        },
