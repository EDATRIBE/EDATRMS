...
from ..models import SearchLoadSchema, IPTagsSchema
from ..services import IPService, AnimationService,NovelService
...
async def keywords(request):
    ...
    for keyword in keywords:
        ...
        result_ip_ids |= set([ip['id'] for ip in ips]) | \
    ...
    return response_json(
        ips=await dump_ip_infos(request, result_ips)
    )